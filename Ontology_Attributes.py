...
#########################################################################
    ...
    for line in open('./GO_Children&Parents.txt', mode='rb'):
        if "GO" in line:
    ...
    for line in GO_Nodes:
        if line not in Nodes_Seen:
            GO_Nodes_Refined.append(line)
